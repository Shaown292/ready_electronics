                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: GestureDetector(
                          onTap: ()=> Navigator.push(context, MaterialPageRoute(builder: (context)=>  AddShippingAddressPage(total: widget.total,))),
                            child: const Center(
                                child: RobotoText(
                          text: "change",
                ...
                onTap: () {
                  ...
                  if (name.isEmpty ||
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                AddShippingAddressPage(total: widget.total,)));
