                      ...
                      builder: (data) {
                        ...
                        return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              var product =
                                  data.cardData[index].values.toList();
                              int price = product[0];
                              tempPrice += price;

                              try {
                                setState(() => totalPrice = tempPrice);
                              } catch (e) {
                                print(e.toString());
                              }
                              return Card(
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        RobotoText(
                                          text:
                                              "You're saving ${price.totalDiscountPrice} in this order",
                                          size: 15.0,
                                          fontWeight: FontWeight.w500,
                                          color: Colors.white,
                                        )
